      ...
      <div className=' lg:mt-32 mt-11'>
        {tabChoice === 1 ?
          <>
            ...
            <details className="dropdown lg:hidden inline-block w-full text-center ">
              <summary className="btn bg-ctp-yellow text-black  m-1">Click to show other skills</summary>
